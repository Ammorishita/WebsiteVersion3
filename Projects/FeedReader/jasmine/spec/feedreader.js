...
$(function() {
    ...
    */
         ...
         */
          ...
          */
          it('Menu changes visibility on click', function() {
            ...
            //Click menu on start up to check class.
            menuIcon.click();
            expect($('body').hasClass('menu-hidden')).toBe(false);
            //Click menu again to close and check class.
            menuIcon.click();
            expect($('body').hasClass('menu-hidden')).toBe(true);
          });
    ...
    describe('New Feed Selection', function() {
        var feed1, feed2;
        //The content of feed on start up is blank since the loadFeed function hasnt completed.

        //Run loadFeed twice before the test.
        beforeEach(function(done) {          
            loadFeed(1, function() {
                feed1 = $('.feed').html();
                console.log(feed1);
                //Run the second loadFeed after the first completes.
                loadFeed(2, function() {  
                    feed2 = $('.feed').html();
                    console.log(feed2); 
                    done(); 
